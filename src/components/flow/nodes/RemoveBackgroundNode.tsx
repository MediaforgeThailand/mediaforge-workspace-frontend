...
const SCHEMA = NODE_API_SCHEMA.removeBackgroundNode;
...
const RemoveBackgroundNode = memo(({ id, data, selected }: NodeProps) => {
  const d = data as unknown as RemoveBackgroundNodeData;
  ...
  const nodeCost = useMemo(() => {
    ...
    return calculateNodeCost({ schemaKey: "removeBackgroundNode", params, creditCosts });
  }, [params, creditCosts]);
