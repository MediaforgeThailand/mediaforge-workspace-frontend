          ...
          {filteredOptions.map((option, idx) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex w-full items-center gap-2 px-2 py-1 text-left text-[10px] leading-tight transition-colors",
                  idx === selectedIndex
              ...
              >
                {option.previewUrl ? (
                  <span className="flex h-7 w-7 shrink-0 items-center justify-center overflow-hidden rounded-md border border-white/10 bg-white/[0.04]">
                    <img
                ...
                <span className="ml-auto shrink-0 font-mono text-[8px] text-white/20">
