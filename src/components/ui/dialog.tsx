...
/**
 * DialogContent — borderless elevated panel.
 *
 * 2026-05 redesign:
 *   • Drop the 1px border — the dialog reads as a Layer-2 card on a
 *     dimmed Layer-0 backdrop, no hairline needed.
 *   • bg-background → bg-card so dialogs sit a step above the page.
 *   • Default corner radius bumped to xl (16px) to match Card.
 */
