...
const VFX_PREPROCESS_MODEL_LABELS: Record<(typeof VFX_PREPROCESS_MODELS)[number], string> = {
  "vfx-preprocess-comfy": "Comfy VFX Preprocess",
};

const vfxPreprocessModelParam = (): ParamDef => ({
  key: "model_name",
  label: "Engine",
  type: "select",
  options: [...VFX_PREPROCESS_MODELS],
  optionLabels: VFX_PREPROCESS_MODEL_LABELS,
  default: "vfx-preprocess-comfy",
  required: true,
  group: "Workflow",
});
...
export const WORKSPACE_SCHEMA: Record<string, NodeApiDef> = {
  vfxVariableNode: {
    ...
    defaultModel: "vfx-preprocess-comfy",
    inputs: [
      { id: "input_video", label: "INPUT VIDEO", color: "emerald" },
      { id: "start_image", label: "START IMAGE", color: "blue" },
      { id: "ref_image", label: "REF IMAGE", color: "blue", maxConnections: 4 },
      { id: "mask_image", label: "MASK IMAGE", color: "white/30" },
      { id: "mask_video", label: "MASK VIDEO", color: "white/30" },
      { id: "text", label: "TEXT", color: "sky" },
    ],
    outputs: [
      { id: "input_video", label: "INPUT VIDEO", color: "emerald" },
      { id: "video_info", label: "VIDEO INFO", color: "sky" },
      { id: "width_value", label: "WIDTH", color: "sky" },
      { id: "height_value", label: "HEIGHT", color: "sky" },
      { id: "fps_value", label: "FPS", color: "sky" },
      { id: "start_image", label: "START IMAGE", color: "blue" },
      { id: "background_video", label: "01 BG VIDEO", color: "emerald" },
      { id: "background_image", label: "01 BG IMAGE", color: "blue" },
      { id: "depth_video", label: "02 DEPTH VIDEO", color: "violet" },
      { id: "canny_video", label: "03 CANNY VIDEO", color: "sky" },
      { id: "pose_video", label: "04 POSE VIDEO", color: "pink" },
      { id: "track_video", label: "05 TRACK VIDEO", color: "green" },
      { id: "mask_video", label: "MASK VIDEO", color: "white/30" },
      { id: "mask_image", label: "MASK IMAGE", color: "white/30" },
      { id: "text", label: "TEXT", color: "sky" },
    ],
    params: [
      ...
      },
      {
        ...
        label: "Resolution",
        type: "select",
        options: ["720p", "1080p", "custom"],
        optionLabels: { "720p": "720p", "1080p": "1080p", custom: "Custom" },
        default: "720p",
        group: "Video",
      },
      {
        ...
        optionLabels: { "16:9": "16:9", "9:16": "9:16", "1:1": "1:1", custom: "Custom" },
        default: "16:9",
        group: "Video",
      },
      { key: "custom_width", label: "Width", type: "slider", default: 896, min: 512, max: 3840, step: 16, group: "Advanced Video" },
      { key: "custom_height", label: "Height", type: "slider", default: 512, min: 512, max: 2160, step: 16, group: "Advanced Video" },
  ...
  vfxStartFrameNode: {
    displayName: "VFX Start Frame",
    category: "VFX",
    accentColor: "amber",
    supportedModels: [...VFX_PREPROCESS_MODELS],
    defaultModel: "vfx-preprocess-comfy",
    inputs: [{ id: "input_video", label: "INPUT VIDEO", color: "emerald", required: true }],
    ...
    params: [
      ...
      { key: "frame_load_cap", label: "Frame Cap", type: "slider", default: 1, min: -1, max: 600, step: 1, group: "Advanced Input" },
      { key: "skip_first_frames", label: "Skip Frames", type: "slider", default: 0, min: 0, max: 600, step: 1, group: "Advanced Input" },
      { key: "force_rate", label: "Force FPS", type: "slider", default: 0, min: 0, max: 60, step: 1, group: "Advanced Input" },
      {
      ...
      },
      {
        ...
        options: ["AnimateDiff"],
        default: "AnimateDiff",
        group: "Advanced Output",
      },
      {
        key: "output_prefix",
        label: "Output Prefix",
        type: "text",
        default: "AIVFX-PREPROCESS/STARTIMG",
        group: "Advanced Output",
      },
    ],
  },
  vfxBackgroundNode: {
    displayName: "VFX Background",
    category: "VFX",
    accentColor: "emerald",
    supportedModels: [...VFX_PREPROCESS_MODELS],
    defaultModel: "vfx-preprocess-comfy",
    inputs: [
      { id: "input_video", label: "INPUT VIDEO", color: "emerald", required: true },
      { id: "start_image", label: "START IMAGE", color: "blue" },
    ],
    outputs: [
      { id: "background_video", label: "BG VIDEO", color: "emerald" },
      { id: "background_image", label: "BG IMAGE", color: "blue" },
    ],
    params: [
      vfxPreprocessModelParam(),
      vfxFrameSyncParam(),
      {
        ...
        label: "Mode",
        type: "select",
        options: ["grey_50", "empty_plate", "source_plate"],
        optionLabels: {
          grey_50: "50% Grey Control",
          empty_plate: "Empty Background Plate",
          source_plate: "Use Source Plate",
        },
        default: "grey_50",
        group: "Background",
      },
      { key: "width", label: "Width", type: "slider", default: 1280, min: 512, max: 3840, step: 16, group: "Size" },
      { key: "height", label: "Height", type: "slider", default: 720, min: 512, max: 2160, step: 16, group: "Size" },
      { key: "fps", label: "FPS", type: "slider", default: 24, min: 1, max: 60, step: 1, group: "Size" },
      ...
      },
      {
        ...
        label: "Output Prefix",
        type: "text",
        default: "AIVFX-PREPROCESS/BACKGROUND",
        group: "Advanced Output",
      },
    ],
  },
  vfxDepthNode: {
    displayName: "VFX Depth",
    category: "VFX",
    accentColor: "violet",
    supportedModels: [...VFX_PREPROCESS_MODELS],
    defaultModel: "vfx-preprocess-comfy",
    inputs: [{ id: "input_video", label: "INPUT VIDEO", color: "emerald", required: true }],
    outputs: [
      { id: "depth_video", label: "DEPTH VIDEO", color: "violet" },
      { id: "depth_image", label: "DEPTH IMAGE", color: "violet" },
    ],
    params: [
      vfxPreprocessModelParam(),
      vfxFrameSyncParam(),
      {
        ...
        label: "Depth Model",
        type: "select",
        options: ["depthcrafter"],
        optionLabels: { depthcrafter: "DepthCrafter" },
        default: "depthcrafter",
        group: "Depth",
      },
      { key: "num_inference_steps", label: "Steps", type: "slider", default: 5, min: 1, max: 25, step: 1, group: "Advanced Depth" },
      { key: "guidance_scale", label: "Guidance", type: "slider", default: 1.0, min: 0, max: 5, step: 0.1, group: "Advanced Depth" },
      { key: "window_size", label: "Window", type: "slider", default: 81, min: 8, max: 161, step: 1, group: "Advanced Depth" },
      { key: "overlap", label: "Overlap", type: "slider", default: 14, min: 0, max: 80, step: 1, group: "Advanced Depth" },
      { key: "crf", label: "CRF", type: "slider", default: 19, min: 10, max: 35, step: 1, group: "Advanced Output" },
      { key: "output_prefix", label: "Output Prefix", type: "text", default: "AIVFX-PREPROCESS/DEPTH", group: "Advanced Output" },
    ],
  },
  vfxCannyNode: {
    displayName: "VFX Canny",
    category: "VFX",
    accentColor: "sky",
    supportedModels: [...VFX_PREPROCESS_MODELS],
    defaultModel: "vfx-preprocess-comfy",
    inputs: [{ id: "input_video", label: "INPUT VIDEO", color: "emerald", required: true }],
    outputs: [
      { id: "canny_video", label: "CANNY VIDEO", color: "sky" },
      { id: "canny_image", label: "CANNY IMAGE", color: "sky" },
    ],
    params: [
      vfxPreprocessModelParam(),
      vfxFrameSyncParam(),
      ...
      { key: "crf", label: "CRF", type: "slider", default: 19, min: 10, max: 35, step: 1, group: "Advanced Output" },
      { key: "output_prefix", label: "Output Prefix", type: "text", default: "AIVFX-PREPROCESS/CANNY", group: "Advanced Output" },
    ],
  },
  vfxPoseNode: {
    displayName: "VFX Pose",
    category: "VFX",
    accentColor: "pink",
    supportedModels: [...VFX_PREPROCESS_MODELS],
    defaultModel: "vfx-preprocess-comfy",
    inputs: [{ id: "input_video", label: "INPUT VIDEO", color: "emerald", required: true }],
    outputs: [
      { id: "pose_video", label: "POSE VIDEO", color: "pink" },
      { id: "pose_image", label: "POSE IMAGE", color: "pink" },
    ],
    params: [
      vfxPreprocessModelParam(),
      vfxFrameSyncParam(),
      {
        ...
        type: "select",
        options: ["dwpose"],
        optionLabels: { dwpose: "DWPose Estimator" },
        default: "dwpose",
        group: "Pose",
      },
      {
      ...
      { key: "pose_resolution", label: "Resolution", type: "slider", default: 768, min: 256, max: 1536, step: 64, group: "Advanced Pose" },
      { key: "crf", label: "CRF", type: "slider", default: 19, min: 10, max: 35, step: 1, group: "Advanced Output" },
      { key: "output_prefix", label: "Output Prefix", type: "text", default: "AIVFX-PREPROCESS/POSE", group: "Advanced Output" },
    ],
  },
  vfxTrackNode: {
    displayName: "VFX Track",
    category: "VFX",
    accentColor: "green",
    supportedModels: [...VFX_PREPROCESS_MODELS],
    defaultModel: "vfx-preprocess-comfy",
    ...
    outputs: [
      { id: "track_video", label: "TRACK VIDEO", color: "green" },
      { id: "track_image", label: "TRACK IMAGE", color: "green" },
      { id: "tracking_data", label: "TRACK DATA", color: "sky" },
    ],
    params: [
      vfxPreprocessModelParam(),
      vfxFrameSyncParam(),
      {
        ...
        type: "select",
        options: ["cotracker"],
        optionLabels: { cotracker: "CoTracker" },
        default: "cotracker",
        group: "Tracking",
      },
      { key: "points", label: "Points", type: "slider", default: 50, min: 4, max: 256, step: 1, group: "Tracking" },
      { key: "track_length", label: "Track Length", type: "slider", default: 200, min: 8, max: 300, step: 1, group: "Tracking" },
      { key: "track_step", label: "Track Step", type: "slider", default: 12, min: 1, max: 64, step: 1, group: "Advanced Tracking" },
      { key: "confidence_threshold", label: "Confidence", type: "slider", default: 0.04, min: 0, max: 1, step: 0.01, group: "Advanced Tracking" },
      { key: "mask_expand", label: "Track Mask Grow", type: "slider", default: -15, min: -80, max: 80, step: 1, group: "Advanced Tracking" },
      { key: "subject_mask_expand", label: "Subject Mask Grow", type: "slider", default: -35, min: -120, max: 80, step: 1, group: "Advanced Tracking" },
      {
        key: "draw_tracks",
        label: "Draw Tracks",
        type: "select",
      ...
      { key: "crf", label: "CRF", type: "slider", default: 19, min: 10, max: 35, step: 1, group: "Advanced Output" },
      { key: "output_prefix", label: "Output Prefix", type: "text", default: "AIVFX-PREPROCESS/TRACK", group: "Advanced Output" },
    ],
  },
  vfxMaskNode: {
    displayName: "VFX Mask",
    category: "VFX",
    accentColor: "purple",
    supportedModels: [...VFX_PREPROCESS_MODELS],
    defaultModel: "vfx-preprocess-comfy",
    inputs: [
      { id: "input_video", label: "INPUT VIDEO", color: "emerald", required: true },
      { id: "start_image", label: "START IMAGE", color: "blue" },
      { id: "ref_image", label: "REF IMAGE", color: "blue" },
      { id: "mask_image", label: "MASK IMAGE", color: "white/30" },
      { id: "mask_video", label: "MASK VIDEO", color: "white/30" },
    ],
    outputs: [
      { id: "mask_video", label: "MASK VIDEO", color: "white/30" },
      { id: "mask_image", label: "MASK IMAGE", color: "white/30" },
      { id: "mask_plate_video", label: "MASK PLATE VIDEO", color: "emerald" },
      { id: "mask_plate_image", label: "MASK PLATE IMAGE", color: "blue" },
    ],
    params: [
      vfxPreprocessModelParam(),
      vfxFrameSyncParam(),
      {
        ...
        label: "Mask Mode",
        type: "select",
        options: ["green_screen_key", "provided_mask", "sam3"],
        optionLabels: {
          green_screen_key: "Auto Green Screen Key",
          provided_mask: "Use Provided Mask",
          sam3: "SAM3 Segmentation",
        },
        default: "green_screen_key",
        group: "Mask",
      },
      {
        key: "segment_model",
        ...
        type: "select",
        options: ["sam3"],
        optionLabels: { sam3: "SAM3 Segmentation" },
        default: "sam3",
        group: "Mask",
      },
      {
      ...
      { key: "fps", label: "Mask FPS", type: "slider", default: 24, min: 1, max: 30, step: 1, group: "Sync" },
      { key: "frame_load_cap", label: "Frame Cap", type: "slider", default: 240, min: 1, max: 300, step: 1, group: "Sync" },
      { key: "green_min", label: "Green Min", type: "slider", default: 72, min: 0, max: 255, step: 1, group: "Green Screen Key" },
      { key: "green_dominance", label: "Green Dominance", type: "slider", default: 1.18, min: 1, max: 2.5, step: 0.01, group: "Green Screen Key" },
      { key: "spill_tolerance", label: "Spill Tolerance", type: "slider", default: 18, min: 0, max: 120, step: 1, group: "Green Screen Key" },
      { key: "mask_expand", label: "Subject Grow", type: "slider", default: -35, min: -120, max: 96, step: 1, group: "Mask" },
      { key: "mask_blur", label: "Blur", type: "slider", default: 4, min: 0, max: 64, step: 1, group: "Advanced Mask" },
      { key: "plate_mask_expand", label: "Plate Grow", type: "slider", default: -15, min: -120, max: 96, step: 1, group: "Advanced Mask" },
      ...
      { key: "plate_output_prefix", label: "Plate Prefix", type: "text", default: "AIVFX-PREPROCESS/MASK-PLATE", group: "Advanced Output" },
    ],
  },
  vfxQwenImageNode: {
    displayName: "VFX Qwen Image",
    category: "VFX",
    accentColor: "amber",
    supportedModels: [...QWEN_IMAGE_MODELS],
    defaultModel: "qwen-image-edit-2511-runpod",
    inputs: [
      { id: "text", label: "text (prompt)", color: "sky" },
      {
        ...
        label: "ref_image",
        color: "blue",
        supportedModels: ["qwen-image-edit-2511-runpod"],
        maxConnections: 3,
      },
      {
        id: "mask_image",
    ...
    params: [
      {
        ...
        label: "Model",
        type: "select",
        options: [...QWEN_IMAGE_MODELS],
        optionLabels: {
          "qwen-image-runpod": "Qwen Image (Runpod)",
          "qwen-image-edit-2511-runpod": "Qwen Image Edit 2511",
        },
        default: "qwen-image-edit-2511-runpod",
        required: true,
      },
      {
        key: "model_pack",
        label: "Model Pack",
        type: "select",
        options: ["qwen-edit-2511-q5-lightning"],
        optionLabels: {
          "qwen-edit-2511-q5-lightning": "Qwen Edit 2511 Q5 + Lightning",
        },
        default: "qwen-edit-2511-q5-lightning",
        group: "Workflow",
      },
      {
        key: "workflow_preset",
      ...
      },
      {
        ...
        type: "textarea",
        default: "",
        placeholder: "Describe the VFX change or generated plate...",
        required: true,
        group: "Creative",
      },
      {
        ...
        type: "textarea",
        default: "",
        placeholder: "Artifacts to avoid, bad edges, warping, text errors...",
      ...
      },
      {
        ...
        optionLabels: {
          "1:1": "1:1 - 1328 x 1328",
          "16:9": "16:9 - 1664 x 928",
          "9:16": "9:16 - 928 x 1664",
          "4:3": "4:3 - 1472 x 1140",
          "3:4": "3:4 - 1140 x 1472",
          "3:2": "3:2 - 1584 x 1056",
          "2:3": "2:3 - 1056 x 1584",
        ...
        default: "1:1",
        supportedModels: ["qwen-image-runpod"],
        group: "Canvas",
      },
      {
        key: "width",
      ...
      },
      {
        ...
        options: ["off", "on"],
        optionLabels: {
          off: "Off - highest quality",
          on: "On - faster draft",
        },
        default: "on",
        group: "Advanced Performance",
      },
      {
        key: "seed",
        label: "Seed",
  ...
  vfxWanVaceNode: {
    ...
    params: [
      ...
      { key: "fps", label: "FPS", type: "slider", default: 24, min: 1, max: 30, step: 1, group: "Video" },
      { key: "frame_load_cap", label: "Total Frames", type: "slider", default: 240, min: 1, max: 300, step: 1, group: "Video" },
      { key: "chunk_frames", label: "Frames / Chunk", type: "slider", default: 49, min: 9, max: 121, step: 1, group: "Advanced Video" },
      { key: "skip_first_frames", label: "Skip Frames", type: "slider", default: 0, min: 0, max: 600, step: 1, group: "Advanced Video" },
...
const VIDEO_HANDLE_IDS = new Set([
  ...
  "mask_plate_video",
  "output_video",
  "output_background_video",
  "output_depth_video",
  "output_canny_video",
  "output_pose_video",
  "output_track_video",
  "output_mask_video",
  "output_mask_plate_video",
]);
