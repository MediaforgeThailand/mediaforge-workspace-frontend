...
const CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    inputs: [
      { id: "text", type: "text", hint: "-> prompt", hintKey: "workspace.picker.port.to_prompt" },
      { id: "ref_image", type: "image", hint: "-> start image", hintKey: "workspace.picker.port.to_image" },
      { id: "mask_image", type: "image", hint: "-> mask image", hintKey: "workspace.picker.port.to_image" },
    ],
    outputs: [{ id: "image", type: "image", hint: "ref image", hintKey: "workspace.picker.port.image" }],
  },
  {
    ...
    icon: "Film",
    inputs: [
      { id: "input_video", type: "video", hint: "-> source video", hintKey: "workspace.picker.port.to_video" },
      { id: "mask_video", type: "video", hint: "-> mask video", hintKey: "workspace.picker.port.to_video" },
      { id: "ref_image", type: "image", hint: "-> ref image", hintKey: "workspace.picker.port.to_image" },
      { id: "text", type: "text", hint: "-> prompt", hintKey: "workspace.picker.port.to_prompt" },
    ],
    outputs: [{ id: "video", type: "video", hint: "video", hintKey: "workspace.picker.port.video" }],
  },
  {
