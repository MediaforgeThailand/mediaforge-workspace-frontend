...
export function createVfxWorkflowTemplate({
  ...
  const nodes: TemplateNode[] = [
    ...
    toolNode(reference, "vfxQwenImageNode", "Reference Plate", { x: x + 1720, y: y + 170 }, {
      ...
      prompt: "replace the green screen background with a cinematic warehouse interior, keep the actor framing, camera perspective, and realistic studio lighting",
      aspect_ratio: "16:9",
      steps: 40,
      cfg: 4,
    }),
