...
export const STANDALONE_TOOLS: Record<StandaloneToolKey, StandaloneToolDefinition> = {
    ...
    models: [
      {
        ...
        label: "Upscale Mediaforge",
        provider: "MediaForge",
        badge: "Enhance",
        description: "AI image enhancement for sharper, clearer 1K, 2K, or 4K outputs.",
      },
    ],
  },
  video_gen: {
  ...
  voice_translate: {
    key: "voice_translate",
    title: "Translate",
    subtitle: "Translate MP4/MP3 voice while preserving the speaker",
    navLabel: "Translate",
    nodeType: "voiceTranslateNode",
    icon: Languages,
    outputType: "video",
    accent: "hsl(188 90% 52%)",
    defaultModel: "elevenlabs-dubbing-voice-clone",
    models: [
      {
        id: "elevenlabs-dubbing-voice-clone",
        label: "Translate",
        provider: "ElevenLabs",
        badge: "Voice Clone",
        description: "Translate audio or video speech into another language while keeping a similar voice.",
      },
    ],
  },
  auto_subtitle: {
  ...
  url_asset: {
    key: "url_asset",
    title: "URL to Asset",
    subtitle: "Import direct files or public YouTube, Instagram, and Facebook links",
    navLabel: "URL",
    ...
    models: [
      {
        ...
        provider: "URL Import",
        badge: "PNG",
        description: "Save a direct .png URL or supported social image as a workspace asset.",
      },
      {
        id: "url-to-mp4",
        label: "Import MP4",
        provider: "URL Import",
        badge: "MP4",
        description: "Save a direct .mp4 URL or supported social video as a workspace asset.",
      },
      {
        id: "url-to-mp3",
        label: "Import MP3",
        provider: "URL Import",
        badge: "MP3",
        description: "Save a direct .mp3 URL or supported social audio as a workspace asset.",
      },
    ],
  },
};
