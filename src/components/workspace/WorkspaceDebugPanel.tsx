...
const WorkspaceDebugPanel = () => {
  ...
  return (
    <div className="pointer-events-auto fixed bottom-3 right-3 z-50 w-[460px] rounded-md border border-zinc-700 bg-zinc-950/95 text-zinc-200 shadow-xl backdrop-blur">
