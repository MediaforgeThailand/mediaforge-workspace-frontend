...
const LevelMeter: React.FC<{ level: number; peak: number }> = ({
  ...
  return (
    <div className="flex gap-0.5 h-32 w-4">
      {/* Left channel */}
      <div className="flex-1 bg-background-tertiary/60 rounded-sm overflow-hidden relative">
        <div
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      <input
        ...
        disabled={disabled}
        className="h-24 w-2 appearance-none bg-background-tertiary rounded-full cursor-pointer
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      <input
        ...
        onChange={handleChange}
        disabled={disabled}
        className="w-16 h-2 appearance-none bg-background-tertiary rounded-full cursor-pointer
 disabled:opacity-50 disabled:cursor-not-allowed
 [&::-webkit-slider-thumb]:appearance-none
...
export const ChannelStrip: React.FC<ChannelStripProps> = ({
  ...
  return (
    <div
      className={`flex flex-col items-center gap-2 p-3 bg-background-tertiary/60 rounded-lg min-w-[80px]
 ...
 ${
   channel.muted
     ...
     : "bg-background-tertiary text-gray-400 hover:bg-background-elevated"
 }`}
