...
import { getRealtimeAudioGraph } from "@/lib/openreel-core";
...
export const AudioMixer: React.FC<AudioMixerProps> = ({
  ...
  return (
    <div
      className="bg-background-secondary border-t border-border p-4"
    ...
    >
      ...
      <div className="flex gap-2 overflow-x-auto pb-2">
        ...
        {/* Separator */}
        {channels.length > 0 && (
          <div className="w-px bg-background-tertiary mx-2 self-stretch" />
        )}
