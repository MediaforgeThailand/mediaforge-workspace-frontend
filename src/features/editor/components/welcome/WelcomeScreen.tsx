...
import { Button, Switch, Label } from "@/components/openreel-ui";
import { useProjectStore } from "../../stores/project-store";
import { useUIStore } from "../../stores/ui-store";
import { SOCIAL_MEDIA_PRESETS, type SocialMediaCategory } from "@/lib/openreel-core";
...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ initialTab }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-background overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(255,181,51,0.06),transparent_60%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,rgba(124,77,255,0.04),transparent_50%)]" />

      <div className="relative h-full flex flex-col items-center justify-center px-6">
        <div className="w-full max-w-3xl">
          <div className="flex flex-col items-center text-center mb-12">
            <div className="flex flex-col items-center gap-3 mb-8" data-testid="welcome-logo">
              <img
                src="/mediaforge-logo.svg"
                alt="MediaForge"
                className="h-20 sm:h-24 w-auto select-none drop-shadow-[0_0_30px_rgba(232,255,20,0.25)]"
                draggable={false}
              />
