...
const ToastItem = React.forwardRef<HTMLDivElement, ToastItemProps>(
  ...
  return (
    <motion.div
      ref={ref}
      layout
      // V4 a11y: announce to screen readers when a toast appears.
      // `role="status"` + `aria-live="polite"` is the standard pattern.
      // `data-testid` helps automated tests detect notifications.
      role="status"
      aria-live="polite"
      data-testid="toast"
