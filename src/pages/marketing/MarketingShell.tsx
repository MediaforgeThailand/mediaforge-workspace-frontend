  ...
  return (
    <section className="relative overflow-hidden px-5 py-28">
      <div
        ...
        style={{
          background:
            "radial-gradient(60% 60% at 50% 50%, rgba(244,255,0,.22), transparent 70%), linear-gradient(180deg, transparent, rgba(244,255,0,.08))",
        }}
      />
      <div className="reveal-scale mx-auto max-w-4xl rounded-lg border border-white/10 bg-[linear-gradient(135deg,var(--brand-deep),#181022_50%,var(--bg-card))] p-8 text-center shadow-[0_40px_100px_-24px_rgba(238,255,0,.45)] md:p-14">
